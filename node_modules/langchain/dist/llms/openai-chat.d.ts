...
export declare class OpenAIChat extends LLM implements OpenAIChatInput {
    ...
    _identifyingParams(): {
        ...
        baseOptions?: any;
        formDataCtor?: (new () => any) | undefined; /** Penalizes repeated tokens according to frequency */
    ...
    /** @ignore */
    _call(prompt: string, stop?: string[], runManager?: CallbackManagerForLLMRun): Promise<string>;
    /** @ignore */
