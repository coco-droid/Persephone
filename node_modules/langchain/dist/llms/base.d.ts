...
export declare abstract class BaseLLM extends BaseLanguageModel {
     ...
     */
    abstract _generate(prompts: string[], stop?: string[], runManager?: CallbackManagerForLLMRun): Promise<LLMResult>;
    /** @ignore */
    _generateUncached(prompts: string[], stop?: string[], callbacks?: Callbacks): Promise<LLMResult>;
    /**
     * Run the LLM on the given propmts an input, handling caching.
     */
    generate(prompts: string[], stop?: string[], callbacks?: Callbacks): Promise<LLMResult>;
    /**
     * Convenience wrapper for {@link generate} that takes in a single string prompt and returns a single string output.
     */
    call(prompt: string, stop?: string[], callbacks?: Callbacks): Promise<string>;
    /**
...
export declare abstract class LLM extends BaseLLM {
     ...
     */
    abstract _call(prompt: string, stop?: string[], runManager?: CallbackManagerForLLMRun): Promise<string>;
    _generate(prompts: string[], stop?: string[], runManager?: CallbackManagerForLLMRun): Promise<LLMResult>;
}
